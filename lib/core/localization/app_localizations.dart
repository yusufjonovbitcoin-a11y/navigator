...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'en': {
      ...
      'stationary_camera': 'Stationary Camera',
    ...
    'ru': {
      ...
      'stationary_camera': 'Стационарная Камера',
      ...
      'map_layers': 'Слой карты OpenStreetMap',
      'osm_standard': 'OSM Стандартная',
      'osm_dark': 'OSM Темная HUD',
    ...
    'uz': {
      ...
      'stationary_camera': 'Statsionar Kamera',
      ...
      'map_layers': 'OpenStreetMap Karta Qatlami',
      'osm_standard': 'OSM Standart',
      'osm_dark': 'OSM Tungi HUD',
      'satellite': 'Sun\'iy yo\'ldosh tasviri',
